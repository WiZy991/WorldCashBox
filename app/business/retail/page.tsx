...
const features = [
  {
    icon: ShoppingBag,
    title: 'POS-терминалы',
    description: 'Современные кассовые системы с поддержкой всех требований',
  },
  {
    icon: Shield,
    title: 'ОФД, ЕГАИС, Меркурий',
    description: 'Полная поддержка всех государственных систем',
  },
  {
    icon: Package,
    title: 'Маркировка товаров',
    description: 'Регистрация в системе "Честный знак" под ключ',
  },
  {
    icon: BarChart3,
    title: 'Аналитика продаж',
    description: 'Детальная аналитика и отчетность для принятия решений',
  },
]
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-primary-800 via-primary-700 to-primary-900 text-white">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            >
              <span className="text-sm font-semibold">Решения для розничной торговли</span>
            </motion.div>
            ...
            <p className="text-xl md:text-2xl text-white/90 mb-8">
              Комплексные решения для магазинов и аптек
            </p>
            <motion.button
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-600">
              Все необходимое для эффективной работы вашего магазина
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Готовы автоматизировать ваш магазин?
            </h2>
