    ...
    try {
      const response = await fetch('/api/sbis/submit', {
        ...
        body: JSON.stringify({
          ...
          message: 'Заказ фискальных регистраторов',
          product: 'Фискальные регистраторы',
        }),
      })
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-primary-100 mb-8">
              Надежные фискальные регистраторы для вашего бизнеса
            </p>
          ...
          <div className="md:col-span-2">
            <div className="bg-white rounded-2xl shadow-xl p-6">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Поиск фискальных регистраторов..."
                  value={searchQuery}
