...
const pricecheckerBrands = [
  'Newland',
  'S8°',
]

export default function PriceCheckersPage() {
  const [searchQuery, setSearchQuery] = useState('')
  const { openAssistant } = useAssistant()

  const filteredBrands = pricecheckerBrands.filter(brand => 
  ...
  return (
    <div className="min-h-screen pt-20 pb-20 bg-gradient-to-br from-white via-primary-50/30 to-primary-100/30">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-primary-100 mb-8">
              Информационные киоски и прайс-чекеры для торговых залов
            </p>
      ...
      <section className="container mx-auto px-4 py-8">
        <div className="bg-white rounded-2xl shadow-xl p-6 mb-8">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Поиск прайс-чекеров..."
              value={searchQuery}
        ...
        {filteredBrands.length > 0 ? (
          ...
          <div className="text-center py-20 bg-white rounded-2xl shadow-xl">
            ...
            <p className="text-xl text-gray-600 mb-4">Прайс-чекеры не найдены</p>
      ...
      <section className="container mx-auto px-4 py-20">
        ...
        >
          <h2 className="text-4xl font-bold mb-4">Нужна помощь с выбором прайс-чекера?</h2>
          <p className="text-xl text-primary-100 mb-8">
