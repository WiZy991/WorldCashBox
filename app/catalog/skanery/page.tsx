...
export default function ScannersPage() {
  ...
  const filteredBrands = scannerBrands.filter(brand => 
  ...
  return (
    <div className="min-h-screen pt-20 pb-20 bg-gradient-to-br from-white via-primary-50/30 to-primary-100/30">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-primary-100 mb-8">
              Широкий выбор сканеров штрих-кода от ведущих производителей
            </p>
      ...
      <section className="container mx-auto px-4 py-8">
        <div className="bg-white rounded-2xl shadow-xl p-6 mb-8">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Поиск сканеров по производителю..."
              value={searchQuery}
        ...
        {filteredBrands.length > 0 ? (
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {filteredBrands.map((brand, index) => (
              ...
              >
                <ScanLine className="w-12 h-12 text-primary-600 mx-auto mb-4" />
          ...
          <div className="text-center py-20 bg-white rounded-2xl shadow-xl">
            <ScanLine className="w-20 h-20 text-gray-400 mx-auto mb-4" />
            <p className="text-xl text-gray-600 mb-4">Сканеры не найдены</p>
      ...
      <section className="container mx-auto px-4 py-20">
        ...
        >
          <h2 className="text-4xl font-bold mb-4">Нужна помощь с выбором сканера?</h2>
          <p className="text-xl text-primary-100 mb-8">
            Наши специалисты подберут оптимальный сканер для вашего бизнеса
          </p>
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
